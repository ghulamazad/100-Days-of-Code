...
# Screen Dimensions for screen of size 1366X768 1920X1080
top, left, width, height = 250, 0, 400, 265
...
y_search_cactus, x_start, x_end = 200, 200, 210
y_search_bird = 230  # for the birds
...
while True:
    ...
    background_color = pixels[90, 30]

    for i in reversed(range(x_start, x_end)):
        if pixels[i, y_search_cactus] != background_color or pixels[i, y_search_bird] != background_color:
            keyboard.press(' ')  # jump
            break
